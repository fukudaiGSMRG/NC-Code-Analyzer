# 🚀 NC_コードアナライザー_Pro_Ver5_5.exe (NCプログラム検証ツール)
...
作業機械（マシニングセンタ・旋盤）のNCデータ（Gコード）を　ドラッグ＆ドロップ　するだけで、早送り/切削送りの詳細な認識範囲、回転数、送り速度を瞬時に解析します。
...
# アプリの実行
python nc_checker_ultimate_v5_5.py
